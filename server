...
QBCore.Functions.CreateCallback('sickwarrants:getActive', function(source,cb,active)
...
AddEventHandler('sickwarrants:createWarrant', function(source, firstname,lastname,case,bday,reason)
...
AddEventHandler('sickwarrants:setBounty', function(source,amount,case)
...
AddEventHandler('sickwarrants:DeleteWarrant', function(source,case)
